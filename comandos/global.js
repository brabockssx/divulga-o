...
exports.run = async (client,message,args)=>{
    if(!['701124938291216455' , '673521938466996224'].includes(message.author.id)) return message.channel.send("Você não tem permissão.")
...
.setColor(0x00A2E8)
.setAuthor(" Utilize o comando, daqui 10 minutos. Eu também mereço descanso...", message.author.avatarURL)
...
if(!flow) return message.channel.send("caso queira que eu envie o log/enviar em um canal, crie um chamado `saturno`");
//saturno.send(embed);
message.delete();
} else {
...
if(!mensagem) return message.reply({embed: {title: "Global", description: "informe uma mensagem!"}})
...
//para __${usuarios}__ usuários em __${servidores}__ servidores.**`).then(msg => msg.react("✔"))
  ...
  .setThumbnail("https://cdn.discordapp.com/attachments/649408990970642442/651518055654096896/tenor_3.gif")
